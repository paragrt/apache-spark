...
public class OneHotEncode {
	...
	public static void main(String[] args) {
		...
		StringIndexer gIdxr = new StringIndexer().setInputCol("Gender").setOutputCol("GenderIndex");
		
		dataset = gIdxr.fit(dataset).transform(dataset);
		
		OneHotEncoderEstimator ge = new OneHotEncoderEstimator().setInputCols(new String[] {"GenderIndex"})
